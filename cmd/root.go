...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.worktracker.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".worktracker" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".worktracker")
	}
